...
private:
    ...
    vector<double> Q_2; //intermediate vector of bead positions squared
    vector<double> Q_3; //intermediate vector of bead positions cubed
    vector<double> one_vec; //vector of ones
};

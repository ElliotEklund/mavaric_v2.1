...
theta_Esplit_dBeta::theta_Esplit_dBeta(int elec_beads, int num_states,
    ...
    :f_chain(elec_beads), b_chain(elec_beads),
     ...
     M_dbeta(1,num_states,beta_num_beads,1.0/elec_beads,M_In)
{
    C = &C_In;
    M = &M_In;
}
double theta_Esplit_dBeta::get_dtheta(){
    update_dtheta();
    return dtheta;
}
void theta_Esplit_dBeta::update_dtheta(){
...
void theta_Esplit_dBeta::update_dgamma(){

#ifndef rpmd_system_step_hpp
#define rpmd_system_step_hpp
...
class rpmd_system_step{

public:
    rpmd_system_step(int my_id,int num_procs, int root_proc,int num_beads,
                double betaIN);
    ...
    void step(double energy,vector<double> &Q);

/* Mutators */
    void set_hamiltonian(rpmd_ham &H_IN);

...
input_rpmd::input_rpmd()
{}

std::vector<double> input_rpmd::get_parameters(std::string fileName){
...
/* Each of the four input vectors will be filled with their corresponding values after
...
int input_rpmd::input_file_handler(std::string root, std::vector<double> &sysParams,
    ...
    if(is_corrupt(DynFile,8)){result = -1;}
